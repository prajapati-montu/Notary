...
export default function CreatePW() {
    return (
        <>
            <div className='main-com'>
                <div className='col-md-6 login-img' style={{ background: 'linear-gradient(218.22deg, #E57403 -4.99%, #EF880F 23.61%, #FBA11D 66.99%, #FFAA22 93.62%)', padding: '0' }}>
                    <img src='assets/img/login3.png' style={{ height: '100vh', objectFit: 'cover', objectPosition: 'bottom' }} />
                </div>
                <div className='col-md-6 login-form' style={{overflow: 'overlay', padding: '5% 0'}}>
                    <div className='container-fluid col-7'>
                        ...
                        <div className='form-fild mt-5'>
                            ...
                            <div className='col-12'>
                                <div className="form-group">
                                    <label>Passport Number <samp className='note-log'>(If a director is a Foreign national, the following screen will be displayed.)</samp></label>
                                    <div className='d-flex'>
                                        <input
                                            type="number"
                                            name="user_id"
                                    ...
                                    <label>Note : <samp className='note-log'>Enter the First otp from your registered e mail and the last otp from your registered mobile number to complete the verification process. Eg. Email Otp 4126 Mobile Otp 9576, please Enter 4126 9576.</samp></label>
                                </div>
                            </div>
                            <div className='col-12'>
                                <div className="form-group">
