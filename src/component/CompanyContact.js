      ...
      <div className="main-personal">
        ...
        <div className="login-details">
                  ...
                  <div className="radio-group-yes">
                    ...
                    <label className="radio-inline">
                      <input
                        ...
                        name="name"
                        className="form-control"
                        placeholder="Enter Your Company's E Mail Id"
                        required
                      />
                    </label>
                  </div>
            ...
            <div className="btn-path">
                            <Link to={'/CompanyDocumentsForm'} className="btn btn-cancel me-3">Back</Link>

                            <Link to={'/CompanyLogin'} className="btn btn-cancel me-3">Next</Link>
                        </div>
