...
export default function Login() {
    const [isCaptchaValid1, setCaptchaValid1] = useState(false);
    const [isCaptchaValid2, setCaptchaValid2] = useState(false);
    const [isCaptchaValid3, setCaptchaValid3] = useState(false);
    const [isCaptchaValid4, setCaptchaValid4] = useState(false);
    const [isCaptchaValid5, setCaptchaValid5] = useState(false);
    const [isCaptchaValid6, setCaptchaValid6] = useState(false);
    ...
    return (
        <>
            {(category === 'Select User Category' || category === 'Person' || !category) && (
                <>
                    <div className='main-com'>
                        <div className='col-md-6 login-img' style={{ background: '#c87b6b' }}>
                        ...
                        <div className='col-md-6 login-form'>
                            <div className='container-fluid col-7'>
                                ...
                                <div className='form-fild mt-5'>
                                        ...
                                        <div className="form-group">
                                            ...
                                            <div>
                                                ...
                                                >
                                                    ...
                                                    <option value={'Company / Lip'}>Company / Lip</option>
                                                    <option value={'Director / Designated Partner'}>Director / Designated Partner</option>
                                                    <option value={'Propritorship Firm'}>Propritorship Firm</option>
                                    ...
                                    <div className="col-12">
                                        <div className="form-group">
                                            ...
                                            <input
                                                ...
                                                required
                                            />
                                            <Link className='for-pas'><p>Forgot Password?</p></Link>
                                        </div>
                                    </div>
                                    ...
                                    <Capture onValidate={(isValid) => setCaptchaValid1(isValid)} />
                                </div>
                                <div className="d-flex justify-content-center mt-5">
                                    <Link to={'/'} className="btn btn-cancel me-3 small-long" style={{ width: '80%' }}>Sign in</Link>
                                </div>
                                <div className='sinup mt-3'>
                                    <p>Don't have an account? <Link><b>Sign Up</b></Link></p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className='col-md-6 login-form'>
                        <div className='container-fluid col-7'>
                            ...
                            <div className='form-fild mt-5'>
                                ...
                                <Capture onValidate={(isValid) => setCaptchaValid2(isValid)} />
                            </div>
                            <div className="d-flex justify-content-center mt-5">
                                <Link to={'/'} className="btn btn-cancel me-3 small-long" style={{ width: '80%' }}>Sign in</Link>
                            </div>
            ...
            {category === 'Director / Designated Partner' && (
                <div className='main-com'>
                    ...
                    <div className='col-md-6 login-form'>
                        <div className='container-fluid col-7'>
                            ...
                            <div className='form-fild mt-5'>
                                ...
                                <div className="col-12">
                                    <div className="form-group" style={{ marginBottom: '10px' }}>
                                        ...
                                        <input
                                            ...
                                            required
                                        />
                                        <Link to={'/create-password'} className='for-pas' style={{ float: 'right' }}><p>Create Password?</p></Link>
                                    </div>
                                </div>
                                <div className="col-12">
                                    <div className="form-group" style={{ marginBottom: '10px' }}>
                                ...
                                <Capture onValidate={(isValid) => setCaptchaValid3(isValid)} />
                            </div>
            ...
            {category === 'Propritorship Firm' && (
                <div className='main-com'>
                    <div className='col-md-6 login-img' style={{ background: '#164370', padding: '0' }}>
                        <img src='assets/img/login4.png' style={{ height: '100vh', objectFit: 'cover', objectPosition: 'bottom' }} />
                    </div>
                    <div className='col-md-6 login-form'>
                        <div className='container-fluid col-7'>
                            <h1>Welcome back</h1>
                            ...
                            <div className='form-fild mt-5'>
                                ...
                                <Capture onValidate={(isValid) => setCaptchaValid4(isValid)} />
                            </div>
                            <div className="d-flex justify-content-center mt-5">
                                <Link to={'/'} className="btn btn-cancel me-3 small-long" style={{ width: '80%' }}>Sign in</Link>
                            </div>
            ...
            {category === 'Partnership Firm' && (
                <div className='main-com'>
                    <div className='col-md-6 login-img' style={{ background: 'rgb(68 71 75)', padding: '0' }}>
                        <img src='assets/img/login4.png' style={{ height: '100vh', objectFit: 'cover', objectPosition: 'bottom' }} />
                    </div>
                    <div className='col-md-6 login-form'>
                        <div className='container-fluid col-7'>
            ...
            {category === 'Employee or Other Users' && (
                <div className='main-com'>
                    ...
                    <div className='col-md-6 login-form'>
                        <div className='container-fluid col-7'>
                            ...
                            <div className='form-fild mt-5'>
                                    ...
                                    <div className="form-group" style={{ marginBottom: '10px' }}>
                                        ...
                                        <div>
                                            ...
                                            >
                                                ...
                                                <option>Propritorship Firm</option>
                                ...
                                <div className="col-12">
                                    <div className="form-group" style={{ marginBottom: '10px' }}>
                                        <label>Assigned E-mail Id</label>
                                        <input
                                            type="email"
                                            name="user_id"
                                            className="form-control"
                                            placeholder="Enter Assigned E-mail Id"
                                            required
                                        />
                                        <Link to={'/create-password-employee'} className='for-pas' style={{ float: 'right' }}><p>Create Password?</p></Link>
                                    </div>
                                </div>
                                <div className="col-12">
                                    <div className="form-group" style={{ marginBottom: '10px' }}>
                                ...
                                <Capture onValidate={(isValid) => setCaptchaValid5(isValid)} />
                            </div>
                            <div className="d-flex justify-content-center mt-1">
                                <Link to={'/'} className="btn btn-cancel me-3 small-long" style={{ width: '80%' }}>Sign in</Link>
                            </div>
                            <div className='sinup mt-2'>
                                <p>Don't have an account? <Link><b>Sign Up</b></Link></p>
                            </div>
                        </div>
                    </div>
